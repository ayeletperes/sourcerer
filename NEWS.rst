...
+ Added rhesus macaque (``Macaca mulatta``) to the IMGT, OGRDB and
  ``airrc-imgt`` sources (``sourcerer imgt download rhesus`` /
  ``sourcerer ogrdb download rhesus`` / ``sourcerer airrc-imgt download rhesus``).
